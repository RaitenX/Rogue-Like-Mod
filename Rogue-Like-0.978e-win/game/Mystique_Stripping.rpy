...
label Mystique_Stripping: 
    ...
    while Round >=0:  
        ...
        if Count != 2:   
            if E_Arms and not E_Over:          
            ...
            elif E_Over and E_Chest and (E_Panties or E_Legs or HoseNum("Mystique") >= 10):          
                #will she lose the overshirt when she's dressed under?
                if ApprovalCheck("Mystique", 750, TabM = 3):
                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 1)
                    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 25, 1)                 
            ...
            elif E_Legs and (E_Panties or HoseNum("Mystique") >= 10):                              
                #will she lose the pants/skirt if she has panties on?
                if ApprovalCheck("Mystique", 1000, TabM = 3) or (E_SeenPanties and not Taboo):
                    $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 50, 5)                
                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 1)
                    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 30, 1)                
                    ...
                    if not E_SeenPanties:
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 2)                              
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 200, 3)
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 3)
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 200, 2)
                        $ E_SeenPanties = 1                
                else:
                    jump Mystique_Strip_Ultimatum          
                ...
                if HoseNum("Mystique") >= 10:
                    if ApprovalCheck("Mystique", 1200, TabM = 3):
                        $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 50, 6)
                    ...
                    if ApprovalCheck("Mystique", 1200, TabM = 3):
                        $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 50, 4)
                        $ P_Focus = Statupdate("Mystique", "Focus", P_Focus, 60, 4)
                    else:    
                        jump Mystique_Strip_Ultimatum
                else:
                    $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 50, 3)
                    $ P_Focus = Statupdate("Mystique", "Focus", P_Focus, 60, 3)
                $ Line = E_Hose
                $ E_Hose = 0
                "She rolls the [Line] down off her legs, leaving them in a small pile."     
                
            elif E_Over and not E_Chest and (E_Panties or HoseNum("Mystique") >= 10):     
                #will she lose the top when she's topless with panties?        
                if ApprovalCheck("Mystique", 1200, TabM = 3) or (E_SeenChest and not Taboo):
                    $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 60, 5)                
                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 2)
                    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 10)   
                    $ P_Focus = Statupdate("Mystique", "Focus", P_Focus, 80, 15)     
                    $ Line = E_Over
                    $ E_Over = 0                       
                    if not E_SeenChest:
                        call MystiqueFace("bemused", 1)
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 3)                              
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 200, 4)
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 3)
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 200, 3)    
                ...
                if ApprovalCheck("Mystique", 1200, TabM = 3) or (E_SeenChest and not Taboo):
                    $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 60, 5)                
                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 2)
                    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 1)
                    $ P_Focus = Statupdate("Mystique", "Focus", P_Focus, 80, 15)     
                    $ Line = E_Chest
                    $ E_Chest = 0   
                ...
                if ApprovalCheck("Mystique", 1350, TabM = 3) or (E_SeenPussy and not Taboo):
                    $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 75, 10)    
                    $ Line = E_Legs
                    $ E_Legs = 0                       
                    if not E_SeenPussy:
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 60, 3)
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 200, 5)
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 4)
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 200, 4)  
                        ...
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 1)                              
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 75, 1)
                        "She unzips and pulls down her [Line], dropping them to the floor."   
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, 2)           
                ...
                if ApprovalCheck("Mystique", 1350, TabM = 3) or (E_SeenPussy and not Taboo):    
                    ...
                    if not E_Chest:
                        if not E_SeenChest:                
                            ...
                            $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 60, 15)                
                            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 3)                              
                            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 75, 1)
                            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 3)
                    else:
                ...
                $ Count = 2        
        $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 70, 2)               #lust/Focus
        if "exhibitionist" in E_Traits:
            $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 200, 2)
        $ P_Focus = Statupdate("Mystique", "Focus", P_Focus, 60, 3)
        if Trigger2 == "jackin":
            $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 200, 2)
        ...
        if P_Focus >= 100 or E_Lust >= 100:                                     #If either of you could cum 
            ...
            if P_Focus >= 100:                                                  #You cum             
                ...
                if "angry" in E_RecentActions:  
                    return    
                $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 200, 5) 
            ...
            if E_Lust >= 100:                                                   #and Mystique cums                    
                call E_Cumming
        ...
        menu:
            ...
            "Keep Going. . ." if Count != 2 and "keepdancing" not in E_RecentActions:
                ...
                if Taboo and E_Strip <= 10:
                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 7)
                elif Taboo or E_Strip <= 10:
                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 5)
                elif E_Strip <= 50:
                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 3) 
                ...
                if "watching" not in E_RecentActions:
                    if Count != 2:
                        if Taboo and E_Strip <= 10:
                            ...
                            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 2)
                            $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 70, 2) 
...
label Mystique_Strip_Ultimatum:      
    ...
    menu:
        ...
        "That's ok, you can stop.":                            
            $ E_Love = Statupdate("Mystique", "Love", E_Love, 50, 2)
            $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 2)
            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 2)
        ...
        "You'd better." if E_Forced:
            ...
            if "stripforced" in E_RecentActions:                    
                call MystiqueFace("angry")
                ch_e ". . ."
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 200, -40)
            else:
                ch_e "Hmm, forceful. . ."
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 200, -40)
        ...
        "You can do better than that. Keep going." if not E_Forced:
            if not ApprovalCheck("Mystique", 300, "O", TabM=5) and not ApprovalCheck("Mystique", 700, "L", TabM=5):                   
                ...
                $ E_SpriteLoc = StageRight 
                return                
            $ E_Love = Statupdate("Mystique", "Love", E_Love, 200, -10)
            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 3)
            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 75, 5)
            $ Tempmod += 25
            $ E_Forced = 1
            call MystiqueFace("sad")
...
label Mystique_Top_Off(Intro = 1, Line = 0, Cnt = 0):                                                    # Will she take her top off? Modifiers
    ...
    if E_SeenChest and ApprovalCheck("Mystique", 600) and not Taboo:                              #You've seen her tits.
        $ Tempmod += 20
    if "exhibitionist" in E_Traits:
        $ Tempmod += (4*Taboo)
    if "dating" in E_Traits or "sex friend" in E_Petnames and not Taboo:
    ...
    if Situation == "auto":  
        ...
        if E_Over: # If she's in a top
            if E_Chest and ApprovalCheck("Mystique", 800, TabM = 1):
                $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 40, 1)
            elif Approval >= 2 or (E_SeenChest and ApprovalCheck("Mystique", 600) and not Taboo):
                $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, 1)
            else:
                return
            $ Line = E_Over
            $ E_Over = 0
            ...
            if not E_Chest:
                if Taboo:
                    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 90, (int(Taboo/20)))   
                call Mystique_First_Topless(1)
                
        if E_Chest:
            if Approval >= 2 or (E_SeenChest and ApprovalCheck("Mystique", 600) and not Taboo):
                $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, 1)
                if Taboo:
                    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 90, (int(Taboo/20)))  
                if Line:
    ...
    if Approval >= 2:                                                                               # Does she assume top off?            
        ...
        if E_Forced:
            call MystiqueFace("sad", 1)
            $ E_Love = Statupdate("Mystique", "Love", E_Love, 20, -2, 1)
            $ E_Love = Statupdate("Mystique", "Love", E_Love, 70, -3, 1)
            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 40, 2)
            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 90, 1)
            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 1)
        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 3)  
        $ Cnt = 1
        while (E_Chest or E_Over) and Cnt:
            menu:                                                                                 #Menu All off?
                ...
                "Just lose the [E_Chest]." if E_Over and E_Chest:
                    ...
                    $ E_Chest = 0   
                    call Mystique_Tits_Up              
                    "Mystique unfastens her [Line] from beneath her [E_Over], and allows it to drop to the floor."   
        ...
        if not E_Chest and not E_Over:             
            ...
            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 90, 1)
            call Mystique_First_Topless  
        $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 80, 3)        
    ...
    menu:
        ...
        "Ok, that's fine." if "no topless" not in E_RecentActions: 
            if "ask topless" not in E_DailyActions:
                $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 80, 3)
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 70, 1)
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 1)
                $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 2)
            if E_Forced:
                $ E_Mouth = "grimace"
                ch_e "How. . . generous of you."
                if "ask topless" not in E_DailyActions:
                    $ E_Love = Statupdate("Mystique", "Love", E_Love, 20, 2)
                    $ E_Love = Statupdate("Mystique", "Love", E_Love, 70, 2)
        ...
        "How about just the [E_Over]?" if E_Over:                                                # asked to go shirtless. 
            if ApprovalCheck("Mystique", 1000, TabM = 3) and E_Chest: #80, 160 taboo 
                call MystiqueFace("sexy") 
                ...
                $ E_Over = 0
                "Mystique shrugs off her [Line]."   
                $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 30, 1)
                $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 60, 1)
                $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 30, 2)
            elif not E_Chest:
                $ E_Eyes = "surprised"
                $ E_Blush = 2
                ...
                menu:
                    ...
                    "I think I could handle it.":
                        if ApprovalCheck("Mystique", 700, "I", TabM=3) or ApprovalCheck("Mystique", 1100, TabM=3):
                            ...
                            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 20, 2)                                                         
                            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 60, 1)
                            call MystiqueFace("sexy")   
                            $ Line = E_Over
                            $ E_Over = 0
                            "Mystique shrugs off her [Line]."   
                            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 30, 1)  
                            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 1)
                            call Mystique_First_Topless   
                        else:   
        ...
        "Come on, Please? [[take it all off]":                                                                      # asked to go topless. 110, 270 Taboo   
            if Approval and ApprovalCheck("Mystique", 600, "L", TabM=1):                 
                ...
                call MystiqueFace("angry")
                ch_e "Again, no."
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, -5)  
                $ E_RecentActions.append("angry")
                $ E_DailyActions.append("angry")   
            else:   
                call MystiqueFace("sexy")
...
label Mystique_Top_Off_Refused:                    #When you insist but she refuses    
    ...
    menu:
        ...
        "Yes, it is.":
            ...
            ch_e "Very well."
            $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 50, 5)
            $ E_Love = Statupdate("Mystique", "Love", E_Love, 70, -5, 1)
            if "no topless" not in E_RecentActions:
                $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 70, 5)
                $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 60, 5)    
            $ E_RecentActions.append("angry")
            $ E_DailyActions.append("angry")   
...
label Mystique_ToplessorNothing:
    ...
    if ApprovalCheck("Mystique", 1000, "OI", TabM = 4) and ApprovalCheck("Mystique", 500, "O", TabM = 3):       
        ...
        $ E_Love = Statupdate("Mystique", "Love", E_Love, 20, -2, 1)
        $ E_Love = Statupdate("Mystique", "Love", E_Love, 80, -5, 1)
        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 2)
        if "no topless" in E_RecentActions:             
            ch_e "Oh, very well. . ."                 
        else:
            call MystiqueFace("sad")
            ch_e "Fine."                
        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 60, 5)
        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 90, 2)
        if E_Over:
            if E_Chest:        
                $ Line = E_Over
                $ E_Over = 0 
        ...
        $ E_Love = Statupdate("Mystique", "Love", E_Love, 200, -10)                
        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 40, -1, 1)
        if "no topless" in E_RecentActions: 
            $E_Brows = "angry"
...
label Mystique_First_Topless(Silent = 0, TempLine = 0):          
    ...
    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, 15)  
    if not Silent:
        ...
        menu:
            extend ""
            "Definitely, and more.":            
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 20)
                $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, 20)               
                call MystiqueFace("smile",1)
                ch_e "I do aim to impress."
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 40, 20)  
                $ E_Blush = 0
            ". . . [[stunned]":            
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 20)
                $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, 30)
                ch_e "Yes, that would be the usual reaction."
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 40, 10)  
            "Huh, not what I was expecting. . .":        
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, -30)
                $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 60, 25)
                $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, -15)                          
                ...
                menu:        
                    "They're even better than I imagined!":    
                        $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 20)
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 60, -20)
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, 20)                          
                    ...
                    "I, um, no, they're great!":                        
                        ...
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, 10)   
                ...
                if TempLine:
                        call MystiqueFace("angry")
                        $ E_Mouth = "surprised"                        
                        $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, -10)
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 80, 30)
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, -25)  
                        ". . ."
                        $ E_Mouth = "sad"
                        if TempLine == "Rogue":
                                if E_LikeRogue >= 800:
                                    call MystiqueFace("sly",2,Eyes="side")
                                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 80, 5)
        ...
        if ApprovalCheck("Mystique", 800) and not E_Forced:                #if she's not forced and happy about it
            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, 15) 
            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 70, 15)              
            call MystiqueFace("smile")
        else:                                                           #if she's not happy about it
            $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, -40)
            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, -20)                          
            call MystiqueFace("angry")
            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 70, 40)
    return
...
label Mystique_Bottoms_Off(Intro = 1, Line = 0, Cnt = 0):
    ...
    if E_SeenPussy and ApprovalCheck("Mystique", 800): #You've seen her Pussy.
        $ Tempmod += 20
    elif not E_Panties:
        $ Tempmod -= 20
    elif E_SeenPanties and ApprovalCheck("Mystique", 600): #You've seen her panties.
        $ Tempmod += 5 
    if Intro == "dildo":
        $ Tempmod += 20
    if "exhibitionist" in E_Traits:
    ...
    if Situation == "auto":
            ...
            if not E_Upskirt:                      
                if E_Legs == "skirt" and not E_Upskirt:                                          
                    ...
                    if Approval >= 2 or (E_SeenPussy and ApprovalCheck("Mystique", 700) and not Taboo):
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 1)
                        if Taboo:
                            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 90, (int(Taboo/20)))                 
                        $ E_Upskirt = 1
                ...
                if PantsNum("Mystique") >= 5 or HoseNum("Mystique") >= 5:            
                    ...
                    if Taboo:
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 90, (int(Taboo/10)))  
                    $ Cnt = 1 
            ...
            if E_Panties and not E_PantiesDown:                                              
                ...
                if Approval >= 2 or (E_SeenPussy and not Taboo):
                    ...
                    if Cnt:
                        ...
                        "Mystique tsks in irritation, and tugs her [E_Panties] down." 
                    call Mystique_First_Bottomless(1) 
    ...
    if Approval >= 2:                 
            ...
            if not E_Panties and Action_Check("Mystique", "recent", "bottomless") < 2: 
                $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 2)
                $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 90, 1)
                $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 3)
                $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 80, 3)
            ...
            menu:            
                ...
                "Ok, never mind." if "no bottomless" not in E_RecentActions:  
                    if "ask bottomless" not in E_DailyActions:
                        $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 80, 2)
                        $ E_Love = Statupdate("Mystique", "Love", E_Love, 70, 1)
                        $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 1)
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 2)
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 50, 2)
                    if E_Forced:
                        ...
                        ch_e "Very. . . generous."
                        if "ask bottomless" not in E_DailyActions:
                            $ E_Love = Statupdate("Mystique", "Love", E_Love, 20, 3)
                            $ E_Love = Statupdate("Mystique", "Love", E_Love, 70, 4)
                            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 2)
                ...
                "It doesn't have to be everything. . ." if E_Legs or HoseNum("Mystique") >= 10 or E_Panties == "shorts":    
                    if Approval and "no bottomless" not in E_DailyActions:                    
                        ...
                        call MystiqueFace("sexy")
                        call Mystique_Bottoms_Off_Refused                                
                "It doesn't have to be everything. . . (locked)" if not E_Legs and HoseNum("Mystique") < 10 and E_Panties != "shorts":   
                    pass
                    
                "No, lose 'em.":            #85 and -200 taboo             
                    if (Approval and E_Obed >= 250) or (ApprovalCheck("Mystique", 1000, "OI", TabM = 5) and ApprovalCheck("Mystique", 500, "O", TabM = 3)):                    
                        $ E_Love = Statupdate("Mystique", "Love", E_Love, 20, -1, 1)
                        $ E_Love = Statupdate("Mystique", "Love", E_Love, 70, -5, 1)
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 4)
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 80, 1)
                        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 1)
                        $ Line =  "Don't test me. . ."  
    ...
    while Cnt and (E_Legs or E_Panties or E_Hose):
        menu:                                       # She's asking what you'd like to see.
            ...
            "Everything. . ." if Line != "Well what did you have in mind then?": #approval a given
                    ...
                    if Approval < 2 and not E_Panties and HoseNum("Mystique") < 10:
            ...
            "Lose the [E_Legs]." if E_Legs: 
                    ...
                    $ Line = E_Legs      
                    $ E_Legs = 0
                    if not E_Panties and HoseNum("Mystique") < 10:
            ...
            "Lose the [E_Panties]." if E_Panties:
                    if Approval < 2:
                        ...
                        $ E_DailyActions.append("no bottomless")   
                        return                        
                    elif E_Legs == "pants" or HoseNum("Mystique") >= 5:
...
#                    if E_Legs:
#                        ch_e "All right, fine."                         
#                    elif Approval < 2 and not E_Panties and HoseNum("Mystique") >= 10:
#                        call Mystique_NoPanties                            
...
label Mystique_NoPanties: 
    ...
    if not R_Panties:
        return
    if E_Legs or HoseNum("Mystique") >= 10:
...
label Mystique_Bottoms_Off_Refused:     
    ...
    menu:
        ...
        "No, no, never mind." if "no bottomless" not in E_RecentActions:
            $ E_Mouth = "smile"
            $ E_Love = Statupdate("Mystique", "Love", E_Love, 70, 2)    
            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 60, 2)  
            ch_e "Excellent."    
        ...
        "Yeah, let's do something else.":
            ...
            ch_e "Your loss."               
            $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 50, 5)
            $ E_Love = Statupdate("Mystique", "Love", E_Love, 70, -2, 1)
            if "no bottomless" not in E_RecentActions:  
                $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 70, 5)
                $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 60, 4)      
            $ E_RecentActions.append("angry")
            $ E_DailyActions.append("angry")   
...
label Mystique_First_Bottomless(Silent = 0): 
    ...
    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 80, 30)  
    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 70, 10)   
    if not Silent:
        call MystiqueFace("sly")
        ...
        menu:        
            ...
            "Niiice. . .":            
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 20)
                $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 25)            
                call MystiqueFace("smile")          
                ch_e "I'm aware. . . "
                $ E_Love = Statupdate("Mystique", "Love", E_Love, 40, 20)
            "I see you keep it smooth down there." if not E_Pubes:          
                ...
                if ApprovalCheck("Mystique", 700, "LO"):    
                    ...
                    menu:
                        ...
                        "Yes":
                            if ApprovalCheck("Mystique", 900, "LO"):
                                $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 30)
                                $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 25)        
                        ...
                        "Up to you, I guess.":
                                $ E_Love = Statupdate("Mystique", "Love", E_Love, 80, 10)
                    ...
                    $ E_Love = Statupdate("Mystique", "Love", E_Love, 40, -20) 
                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 25)
                    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, -5)         
            ...
            "Not bad for someone your age.":        
                ...
                if not E_Forced and not ApprovalCheck("Mystique", 900, "LO"):                    
                        $ K_RecentActions.append("angry")
                        $ K_DailyActions.append("angry")  
                        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 70, 25)
                ch_e "You will regret that remark. . ."
    else:
        
        if ApprovalCheck("Mystique", 800) and not E_Forced:
            $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 20)
            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 25)          
            call MystiqueFace("smile")          
            $ E_Love = Statupdate("Mystique", "Love", E_Love, 40, 20)
            ...
            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 70, -20)
            call MystiqueFace("angry")          
            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 70, 30)
    return
...
label Mystique_First_Peen(Silent = 0, Undress = 0, GirlsNum = 0): #checked each time she sees your cock  ## call Mystique_First_Peen(0,1)
    ...
    $ E_SeenPeen += 1                      
    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 30, 2) 
    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 80, 1)
    if Undress:
    ...
    if not Silent:        
        ...
        if False:
#        if not ApprovalCheck("Mystique", 800) and not ApprovalCheck("Mystique", 400, "I") and "detention" not in E_RecentActions and "classcaught" not in E_RecentActions:
                ...
                if E_SeenPeen == 1: 
                    $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, -10)                
                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 35)
                    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 20)
                else:                    
                    ...
                    if Action_Check("Mystique", "daily", "peen") >= 2:
                            ...
                            $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, -5)                
                            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 12)
                            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 10)                            
        elif (Taboo and not ApprovalCheck("Mystique", 1500) or E_SEXP < 10) and bg_current != "bg showerroom":
                ...
                if E_SeenPeen == 1: 
                    ...
                    $ E_Love = Statupdate("Mystique", "Love", E_Love, 30, 15) 
                    $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 15)                
                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 25)
                    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 35)  
                ...
                if E_SeenPeen == 1: 
                    ...
                    call MystiqueFace("bemused",1)  
                    $ E_Love = Statupdate("Mystique", "Love", E_Love, 50, 5)
                    $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 10) 
                elif E_SeenPeen == 2:  
                    $ E_Eyes = "down"
                    ch_e "Oh, hello again."               
                ...
                if E_SeenPeen == 1: 
                    ...
                    $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 7)
                    $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 3)  
                elif E_SeenPeen < 5: 
                ...
                if E_SeenPeen > 10:
                    return
                        ...
                        if E_SeenPeen == 1: 
                            $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 3) 
                        elif E_SeenPeen == 2:      
                            $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 5) 
                        elif E_SeenPeen == 5:          
                            $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 50, 7) 
    ...
    if E_SeenPeen == 1 and "angry" not in E_RecentActions:         
        $ E_Love = Statupdate("Mystique", "Love", E_Love, 50, 10)          
        $ E_Love = Statupdate("Mystique", "Love", E_Love, 90, 10)                
        $ E_Obed = Statupdate("Mystique", "Obed", E_Obed, 90, 20)
        $ E_Inbt = Statupdate("Mystique", "Inbt", E_Inbt, 60, 20) 
        $ E_Lust = Statupdate("Mystique", "Lust", E_Lust, 80, 10)

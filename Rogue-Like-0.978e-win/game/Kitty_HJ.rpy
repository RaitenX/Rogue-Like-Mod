...
label K_LesScene(Bonus = 0): #Repeating strokes
        ...
        menu:
            ...
            "I guess I should probably get going then. . .":
                    ...
                    if Approval >= 2:
                            ...
                            if R_Loc == bg_current:
                                    call R_Les_Response("Kitty",3,Bonus2=Bonus)                          
                            elif E_Loc == bg_current:
                                    call E_Les_Response("Kitty",3,Bonus2=Bonus)
                            if not _result:
                                    return
                    else:
                            # If Kitty is only so/so, but Rogue is on board, she tries to convince Kitty
                            if R_Loc == bg_current:
                                    call R_Les_Response("Kitty",1,Bonus2=Bonus)                         
                            elif E_Loc == bg_current:
                                    call E_Les_Response("Kitty",3,Bonus2=Bonus)                      
                            if not _result:
    ...
    if R_Loc == bg_current:
            ...
            call E_Les_Response("Kitty",1,Bonus2=Bonus)
    if _result:

...
label Mystique_Sleepover(sleepover = 0):  #Mystique_Update   
            ...
            if (newgirl["Mystique"].Sleep >= 3 and ApprovalCheck("Mystique", 800)) or ApprovalCheck("Mystique", 1100, "LI"):                                 
                    ...
                    if bg_current == "bg mystique":
                        call ch__m("You should leave, " + newgirl["Mystique"].Petname + "." )
                    else:
                        call ch__m("I hope to see you in class," + newgirl["Mystique"].Petname + ".")
            if sleepover:            
                if R_Loc == bg_current:
            ...
            menu:
                ...
                "Ok, see you later then. Good night." if not sleepover and bg_current != "bg mystique":                        
                        ...
                        $ newgirl["Mystique"].Inbt = Statupdate("Mystique", "Inbt", newgirl["Mystique"].Inbt, 25, 2)            
                        call MystiqueFace("smile")
                        call ch__m("Yeah, night, " + newgirl["Mystique"].Petname +". . .")
                ...
                "Are you sure I can't stay the night? . ." if not sleepover and not newgirl["Mystique"].Sleep and bg_current == "bg mystique": 
                        if ApprovalCheck("Mystique", 1000) or ApprovalCheck("Mystique", 700, "L") or ApprovalCheck("Mystique", 500, "O"):
                            ...
                            call ch__m("Ehhhh. . . no, not tonight, " + newgirl["Mystique"].Petname +". Sorry.") 
...
label Mystique_Morning:
            ...
            call ch__m("Night, " + newgirl["Mystique"].Petname)                                               #fix add sex option here
...
label Mystique_MorningWood: #Emma_Update   
...
label Mystique_Caught_Masturbating: #Emma_Update   
...
label Mystique_Key: #Emma_Update   
            call Shift_Focus("Mystique")
            call Set_The_Scene
            call MystiqueFace("bemused")
...
label Mystique_Caught: #Emma_Update   
    call Shift_Focus("Emma")
    call Checkout
    ch_e "!!!"        
    $ Line = Trigger
...
## start Emma_Love//////////////////////////////////////////////////////////
label Mystique_Love: #Emma_Update   
    call Shift_Focus("Emma")  
    if E_Event[6]:
            #on repeat attempts
...
label Mystique_Sub:     #Emma_Update   
    call Shift_Focus("Emma")
    if E_Loc != bg_current and "Emma" not in Party:
...
label Mystique_Sub_Asked: #Emma_Update   
    $ Line = 0
    call EmmaFace("sadside", 1)
...
label Mystique_Master:  #Emma_Update   
    call Shift_Focus("Emma")
    if E_Loc != bg_current and "Emma" not in Party:
        "Suddenly, Emma shows up and says she needs to talk to you."
...
label Mystique_Sexfriend:   #Emma_Update   
    $ E_Loc = bg_current
    call Set_The_Scene
    call CleartheRoom("Emma")
    $ E_DailyActions.append("relationship")
...
label Mystique_Fuckbuddy:   #Emma_Update   
    $ E_DailyActions.append("relationship")
...
label Mystique_Daddy:       #Emma_Update   
    $ E_DailyActions.append("relationship")
    call Shift_Focus("Emma")
    ch_e ". . ."
    if "dating" in E_Traits:

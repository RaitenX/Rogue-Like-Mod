...
image Rogue:
    LiveComposite(
        ...
        (0,0), ConditionSwitch(                                                                         #Panties            
            ...
            "R_Panties == 'black larger panties' and R_PantiesDown and R_Wet > 1", "images/RogueSprite/Rogue_undiesBlack_down_wet.png",
            "R_Panties == 'black larger panties' and R_PantiesDown", "images/RogueSprite/Rogue_undiesBlack_down.png",  
            "R_Panties == 'black larger panties' and R_Wet > 1", "images/RogueSprite/Rogue_undiesBlack_wet.png",          
            "R_Panties == 'black larger panties'", "images/RogueSprite/Rogue_undiesBlack.png",
...
image Rogue_Doggy_Ass = LiveComposite(                                                                                          #Lower body
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties back
            ...
            "R_Panties == 'black larger panties'", "images/RogueDoggy/Rogue_Doggy_UndiesBlack_Back.png",   
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties if Down
            ...
            "R_Panties == 'black larger panties' and R_Wet > 1", "images/RogueDoggy/Rogue_Doggy_UndiesBlack_Down_Wet.png",
            "R_Panties == 'black larger panties'", "images/RogueDoggy/Rogue_Doggy_UndiesBlack_Down.png",  
...
#        (0,0), "test_case",
        ...
        (0,0), ConditionSwitch(                                                                                 #Panties if up
            ...
            "R_Panties == 'black larger panties' and R_Wet", "images/RogueDoggy/Rogue_Doggy_UndiesBlack_Wet.png",          
            "R_Panties == 'black larger panties'", "images/RogueDoggy/Rogue_Doggy_UndiesBlack.png",          

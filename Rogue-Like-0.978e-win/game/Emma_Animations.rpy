...
#            ),        
        ...
        (0,0), ConditionSwitch(                                                                         #legs/torso 
        ...
        (0,0), ConditionSwitch(                                                                         #nude lower piercings        
            "not E_Pierce", Null(),  
        ...
        (0,0), ConditionSwitch(                                                                         #boots    
            "E_Boots == 'thigh boots' and E_Legs != 'pants'", "images/EmmaSprite/EmmaSprite_Boots.png",    
            "True", Null(), 
            ),     
        ...
        (0,0), ConditionSwitch(                                                                         #nude peircings        
            "not E_Pierce", Null(),  
...
#            ),
        ...
        (0,0), ConditionSwitch(                                                                         #Overshirt layer       
            ...
            "Emma_Arms == 2", ConditionSwitch(   
                    ...
                    "E_Over == 'jacket'", ConditionSwitch(   
                            "E_Chest == 'corset' or E_Chest == 'black corset'", "images/EmmaSprite/EmmaSprite_Jacket_2Up.png",   
                    ...
                    "E_Over == 'black jacket'", ConditionSwitch(   
                            "E_Chest == 'corset' or E_Chest == 'black corset'", "images/EmmaSprite/EmmaSprite_Jacket_2Up_Black.png",   
                            "E_Chest == 'lace bra'", "images/EmmaSprite/EmmaSprite_Jacket_2Up_Black.png",    
                            "E_Chest == 'sports bra'", "images/EmmaSprite/EmmaSprite_Jacket_2Up_Black.png",  
                            "True", "images/EmmaSprite/EmmaSprite_Jacket_2Down_Black.png", 
                            ),  
                    "E_Over == 'nighty'", ConditionSwitch(   
                            "E_Chest == 'corset' or E_Chest == 'black corset'", "images/EmmaSprite/EmmaSprite_Nighty_2Up.png",   
                    ...
                    "E_Over == 'towel'", ConditionSwitch(   
                            "E_Chest == 'corset' or E_Chest == 'black corset'", "images/EmmaSprite/EmmaSprite_Towel_Up2.png",   
        ...
        (0,0), ConditionSwitch(                                                                         #clothed peircings        
            ...
            "E_Pierce == 'barbell'", ConditionSwitch(   
                    ...
                    "E_Chest == 'corset' or E_Chest == 'black corset'", "images/EmmaSprite/EmmaSprite_Pierce_Up_BarOut.png",   
            ...
            "E_Pierce == 'ring'", ConditionSwitch(   
                    ...
                    "E_Chest == 'corset' or E_Chest == 'black corset'", "images/EmmaSprite/EmmaSprite_Pierce_Up_RingOut.png",   
...
image Emma_BJ_HairBack:
    #Hair underlay
    ConditionSwitch(                                                                            
#            "E_Water and E_Hair == 'evo'", "images/EmmaBJFace/Emma_BJ_HairBackWet.png",
#            "E_Hair == 'wet'", "images/EmmaBJFace/Emma_BJ_HairBackWet.png",
            "E_Hair", "images/EmmaBJFace/Emma_BJ_Hair_Wave_Back.png",            
            "True", Null(),
            ),
    zoom 1.4
    anchor (0.5, 0.5)
...
image Emma_BJ_Backdrop:                                                                        
    ...
    LiveComposite(    
        ...
        (0,0),"images/EmmaBJFace/Emma_TJ_Body.png",                                                   
            #body
        (0,0), ConditionSwitch(                                                                         
            #tits
            "renpy.showing('Emma_TJ_Animation')", "images/EmmaBJFace/Emma_TJ_Tits.png", #Titjob animation 
            "E_Chest == 'corset'", "images/EmmaBJFace/Emma_TJ_Tits_Up.png",   # E_TitsUp = 1
            "E_Chest == 'sports bra' or E_Chest == 'lace bra'", "images/EmmaBJFace/Emma_TJ_Tits_Up.png",   # E_TitsUp = 1
            "True", "images/EmmaBJFace/Emma_TJ_Tits_Down.png",   # E_TitsUp = 0
            ), 
#        (0,0), ConditionSwitch(                                                                         
#            #necklace
#            "E_Neck == 'gold necklace'", "images/EmmaBJFace/Emma_BJ_Neck_Gold.png",
#            "E_Neck == 'star necklace'", "images/EmmaBJFace/Emma_BJ_Neck_Star.png",
#            "True", Null(),
#            ),  
#        (0,0), ConditionSwitch(                                                                  
#            # piercings
#            "not E_Pierce", Null(),                       
#            "E_Pierce == 'ring'", "images/EmmaBJFace/Emma_BJ_PierceRing.png",      
#            "True", "images/EmmaBJFace/Emma_BJ_PierceBall.png",   
#            ),   
            
#        (0,0), ConditionSwitch(                                                                        
#            #Bra
#            "not E_Chest", Null(),
#            "E_Chest == 'lace bra'", "images/EmmaBJFace/Emma_BJ_Bra_Lace.png",
#            "E_Chest == 'sports bra'", "images/EmmaBJFace/Emma_BJ_Bra_Sport.png",
#            "E_Chest == 'bra'", "images/EmmaBJFace/Emma_BJ_Bra.png",
#            "E_Chest == 'cami'", "images/EmmaBJFace/Emma_BJ_Bra_Cami.png",
#            "True", Null(),       
#            ),  
...
#            #Shirt
#            "not E_Over", Null(),
#            "E_Over == 'pink top'", "images/EmmaBJFace/Emma_BJ_Over_PinkShirt.png",
#            "E_Over == 'red shirt'", "images/EmmaBJFace/Emma_BJ_Over_RedShirt.png",
#            "E_Over == 'towel'", "images/EmmaBJFace/Emma_BJ_Over_Towel.png",
#            "True", Null(),
#            ),  
        )
    zoom 1.5 
...
#        (0,0), ConditionSwitch(                                                                 
#            #Hair back
#            "E_Water or E_Hair == 'wet'", "images/EmmaBJFace/Emma_BJ_HairBackWet.png", #AlphaMask("images/EmmaBJFace/Emma_BJ_HairBackWet.png", "Emma_BJ_Backdrop"),
#            "True", Null(),
#            ),  
#         (0,0), ConditionSwitch(                                                                 
#            #Hair behind body
##            "E_Water or E_Hair == 'wet'", "images/EmmaBJFace/Emma_BJ_Hair_Wet.png",
##            "E_Hair == 'long'", "images/EmmaBJFace/Emma_BJ_Hair_Long.png",
#            "E_Hair", "images/EmmaBJFace/Emma_BJ_Hair_Wave_Back.png",
#            "True", Null(),
#            ),
         (0,0), ConditionSwitch(                                                                 
...
#            "E_Water or E_Hair == 'wet'", "images/EmmaBJFace/Emma_BJ_Hair_Wet.png",
#            "E_Hair == 'long'", "images/EmmaBJFace/Emma_BJ_Hair_Long.png",            
            "E_Hair", "images/EmmaBJFace/Emma_BJ_Hair_Wave_Mid.png",
            "True", Null(),
            ),
        (0,0), ConditionSwitch(
            # Basic Face layer
...
#            "E_Water or E_Hair == 'wet'", "images/EmmaBJFace/Emma_BJ_Hair_Wet.png",
#            "E_Hair == 'long'", "images/EmmaBJFace/Emma_BJ_Hair_Long.png",
            "E_Hair", "images/EmmaBJFace/Emma_BJ_Hair_Wave_Top.png",
            "True", Null(),
            ),
#        (0,0), ConditionSwitch(                                                                 
#            #Hair water overlay
...
label Emma_BJ_Launch(Line = 0):    # The sequence to launch the Emma BJ animations  
    ...
    if Taboo and Line == "L": # Emma gets started. . .
            "Emma casually glaces around to see if anyone notices what she's doing, but then bends down and puts your cock to her mouth."
    elif Line == "L":    

...
label Mystique_SexDialog_Threeway(Mode = 0, Action = 0, ActiveGirl = Primary, TempLine = 0, TempLust = 0, TempLust2 = 0, TempFocus = 0):
    ...
    call Mystique_Threeway_Set(Mode = Mode)   #Picks a new activty on a 7-9 roll or when not set, otherwise returns
...
# Start Mystique Threeway-set ////////////////////////////////////////////////////////////////////////

label Mystique_Threeway_Set(Preset = 0, Mode = 0, Action = Trigger4, ActiveGirl = Primary, State = "watcher", TempLust = 0, TempLust2 = 0, TempFocus = 0):
    ...
    # for Lesbian: Mystique_Threeway_Set("activity", "lesbian", Trigger3, "Mystique")
    # for Threeway: Mystique_Threeway_Set("activity", 0, Trigger4, "Mystique")

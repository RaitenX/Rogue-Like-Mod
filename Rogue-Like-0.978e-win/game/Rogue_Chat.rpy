...
#            "Say you love her":
        ...
        "Pull her panties down" if (R_Legs == "skirt" or R_Legs == "skirtshort" or R_Legs == "cheerleader skirt" or R_Legs == "cheerleader skirtshort" or not R_Legs) and R_Panties and R_Panties != "swimsuit1" and R_Panties != "swimsuit2" and not R_PantiesDown and not R_Upskirt and not R_Hose:                                         #Flip her skirt           
                    call RogueFace("surprised", 1)
                    $ R_Upskirt = 1
                    $ R_PantiesDown = 1
                    pause 0.5            

...
image Emma_Doggy_Body = LiveComposite(                                                                                         #Upper body
        ...
        #     "not E_Chest", Null(),        
        #     "E_Chest == 'purple bikini bra'", "images/EmmaDoggy/Emma_Doggy_Chest_PurpleBikini.png",
        #     "E_Chest == 'bra'", "images/EmmaDoggy/Emma_Doggy_Chest_UnderBra.png",
        #     "E_Chest == 'lace bra'", "images/EmmaDoggy/Emma_Doggy_Chest_LaceBra.png",
        #     "E_Chest == 'darker lace bra'", "images/EmmaDoggy/Emma_Doggy_Chest_DarkerLace.png",
        #     "True", Null(),            
        #     ), 
...
image Emma_Doggy_Ass = LiveComposite(                                                                                          #Lower body
        ...
        #     #"E_Panties == 'shorts'", "images/RogueDoggy/Rogue_Doggy_Shorts_Back.png",
        #     #"E_Panties == 'red shorts'", "images/RogueDoggy/Rogue_Doggy_Shorts_Back.png",
        #     #"E_Panties == 'blue shorts'", "images/RogueDoggy/Rogue_Doggy_Shorts_Back.png",    
        ...
        #     #"E_Panties == 'black large panties'", "images/RogueDoggy/Rogue_Doggy_UndiesBlack_Back.png",   
        #     #"E_Panties == 'lace panties' or E_Panties == 'black panties'", "images/RogueDoggy/Rogue_Doggy_Panties_Back.png",  
        #     #"E_Panties == 'swimsuit1' or E_Panties == 'swimsuit2'", "images/RogueDoggy/Rogue_Doggy_Swimsuit.png",  
        #     "True", Null(),                     
        #     ),  
        (0,0), ConditionSwitch(                                                                                 #Wet look
        ...
        #     "E_Panties == 'green panties'", "images/EmmaDoggy/Emma_Doggy_Panties_Down_Green.png", 
        #     "E_Panties == 'purple bikini panties'", "images/EmmaDoggy/Emma_Doggy_Panties_Down_Purple.png", 
        ...
        #    "R_Legs == 'pants' and not R_Upskirt and R_HairColor == 'black'", "images/EmmaDoggy/Rogue_Doggy_PubesBlacE_Panties.png",   
        ...
        #    "R_Panties and R_HairColor == 'black'", "images/RogueDoggy/Rogue_Doggy_PubesBlacE_Panties.png",
        ...
        #    "R_Hose and R_Hose != 'stockings' and R_HairColor == 'black'", "images/RogueDoggy/Rogue_Doggy_PubesBlacE_Panties.png",   
        ...
        #     "E_Panties == 'green panties'", "images/EmmaDoggy/Emma_Doggy_Panties_Green.png", 
        #     "E_Panties == 'purple bikini panties'", "images/EmmaDoggy/Emma_Doggy_Panties_Purple.png", 
        ...
        #     "E_Legs == 'black jeans' and E_Upskirt", "images/EmmaDoggy/Emma_Doggy_Legs_BlackJeans_Down.png",            
        #     "E_Legs == 'black jeans' and E_Wet > 1", "images/EmmaDoggy/Emma_Doggy_Legs_BlackJeans_Wet.png",
        #     "E_Legs == 'black jeans'", "images/EmmaDoggy/Emma_Doggy_Legs_BlackJeans.png",
        #     "E_Legs == 'yoga pants' and E_Upskirt", "images/EmmaDoggy/Emma_Doggy_Legs_Yoga_Down.png",            
        #     "E_Legs == 'yoga pants' and E_Wet > 1", "images/EmmaDoggy/Emma_Doggy_Legs_Yoga_Wet.png",
        #     "E_Legs == 'yoga pants'", "images/EmmaDoggy/Emma_Doggy_Legs_Yoga.png",
